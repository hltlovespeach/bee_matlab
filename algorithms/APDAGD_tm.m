function [iter,otvals]=APDAGD_tm(A,r,c,C,epsilon,compute_otvals,time)
...
if compute_otvals
    ...
    for k = 1 : 1 : (maxIter - 1)
        ...
        X_hat = round_transpoly(X,r,c'); %Apply rounding procedure from [Altshuler et al, 2017]
